...
const routes: RouteRecordRaw[] = [
	...
	{ path: '/automations', name: 'automations', component: () => import('@/views/AutomationsView.vue'), meta: { title: 'Automations' } },
...
router.afterEach((to) => {
	...
	if (typeof t === 'string') document.title = `${t} · Tidal`
	else document.title = 'Tidal'
})
